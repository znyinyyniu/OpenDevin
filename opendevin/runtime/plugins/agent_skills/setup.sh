...
$OPENDEVIN_PYTHON_INTERPRETER -m pip install flake8 python-docx PyPDF2 python-pptx pylatexenc openai opencv-python -i https://pypi.tuna.tsinghua.edu.cn/simple
